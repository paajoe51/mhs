...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			...
			<div class="container">
				<div class ="row">
					...
					<div class="col-sm-3">
						<div class="panel-group">
							<div class="panel panel-primary">
								<div class="panel-heading">Total Number of Products</div>
								<div class="panel-body"><?php echo $rowcount?></div>
							</div>
						</div>
					</div>
					...
					<?php 
					include('../connect.php');
						$result = $db->prepare("SELECT * FROM products where qty < 10");
						$result->execute();
						$lowcount = $result->rowcount();
					?>

					<div class="col-sm-3">
						<div class="panel-group">
							<div class="panel panel-danger">
								<div class="panel-heading">Products below QTY 10</div>
								<div class="panel-body"><?php echo $lowcount?></div>
							</div>
						</div>
					</div>
					<?php 
					...
					<div class="col-sm-3">
						<div class="panel-group">
							<div class="panel panel-warning">
								<div class="panel-heading">Total Products Expired</div>
								<div class="panel-body"><?php echo $total?></div>
							</div>
						</div>
					</div>
					...
					$total_price =0;
					include('../connect.php');
						$result = $db->prepare("SELECT  price FROM products");
						$result->execute();
					...
					<div class="col-sm-3">
						<div class="panel-group">
							<div class="panel panel-success">
								<div class="panel-heading">Total Stock amount</div>
								<div class="panel-body"><?php echo $total_price?></div>
							</div>
						</div>
					</div>
				</div>
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php if ($row['qty']<5){
				echo '<td style = "background-color:red" >'.$row['qty']."</td>";	
			}
			else{
				echo '<td>'.$row['qty'].'</td>';
			}
