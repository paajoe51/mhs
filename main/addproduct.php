...
<span>Quantity : </span><input type="number" style="width:60px; height:30px;" min="0" id="txt11" onkeyup="sum();" name="qty" Required ><span style="margin-left:5px; margin-right:5px;">Bar-Code : </span><input type="text" style="width:125px; height:30px; margin-left:-30px;" name="qr" Required disabled id="code-scan"/><br><br>
